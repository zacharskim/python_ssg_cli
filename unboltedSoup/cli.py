...
from unboltedSoup import __app_name__, __version__
import time
...
def init():
    """
    Initialize a unboltedSoup project in the current directory
    """
    ...
    with open('template/default.html', 'w') as f:
        f.write('<html><body><div id="page-content"></div></body></html>')
